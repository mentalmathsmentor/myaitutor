...
import { FragmentList } from '@/components/canvas/FragmentList';
import { PdfPreviewPane } from '@/components/canvas/PdfPreviewPane';
import { CanvasToolbar } from '@/components/canvas/CanvasToolbar';
import { InsertFragmentMenu } from '@/components/canvas/InsertFragmentMenu';
...
export default function CanvasWorkspace({ setCurrentSection, initialConfig }: CanvasWorkspaceProps) {
  ...
  useEffect(() => {
    if (!doc) {
      if (initialConfig) {
        const { document: newDoc, fragments } = createDocumentFromWorksheet(initialConfig);
        setDocument(newDoc);
  ...
  }, [initialConfig, doc, setDocument, setFragments]);

...
export default function SolutionSection() {
  ...
  const solutions = [
    {
      icon: Shield,
      title: 'The Privacy Airlock',
      subtitle: 'Tri-Brain Architecture',
    ...
    },
    {
      ...
      color: 'from-mait-cosmic/20 to-mait-cyan/20',
      iconColor: 'text-mait-cyan',
      gradient: 'from-mait-cosmic to-mait-cyan',
    },
    {
      icon: Heart,
      title: 'The A.G.E. Pipeline',
      subtitle: 'Artifact Generation Engine',
  ...
  const architectureLayers = [
    {
      name: 'The Eye',
      icon: Eye,
      description: 'Local OCR & Image Processing',
      tech: 'Tesseract.js / Moondream',
      color: 'text-blue-400',
    },
    {
      name: 'The Shield',
      icon: Lock,
      description: 'PII Detection & Sanitization',
      tech: 'Custom Regex Filter',
      color: 'text-green-400',
    },
    {
      name: 'The Face',
      icon: Cpu,
      description: 'Edge SLM - Persona & Empathy',
      tech: 'Gemma 2B / Gemini Nano',
      color: 'text-mait-cyan',
    },
    {
      name: 'The Brain',
      icon: Cloud,
      description: 'Cloud LLM - Truth & Reasoning',
      tech: 'Gemini 3.0 Pro',
      color: 'text-mait-cosmic',
    },
  ];
  ...
  return (
    <section id="solution" className="relative py-24 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {shouldReduce ? (
          <div className="absolute bottom-1/4 left-1/4 w-96 h-96 rounded-full bg-mait-cosmic/10 blur-3xl" />
        ) : (
          <motion.div
            className="absolute bottom-1/4 left-1/4 w-96 h-96 rounded-full bg-mait-cosmic/10 blur-3xl"
            animate={{
              scale: [1, 1.1, 1],
              x: [0, 20, 0],
            }}
      ...
      <div ref={ref} className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
            The{' '}
            <span className="gradient-text">MAIT Architecture</span>
          </h2>
          
          <p className="text-lg text-white/60 max-w-2xl mx-auto">
            Not a generic chatbot. A Sovereign Educational AI platform engineered 
            specifically for the NSW HSC context.
          </p>
        </motion.div>
        ...
        {/* Tri-Brain Architecture Diagram */}
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          animate={isInView ? { opacity: 1, y: 0 } : {}}
        ...
        >
          <div className="text-center mb-10">
            ...
            <p className="text-white/60 max-w-xl mx-auto">
              Four layers working in harmony to ensure privacy, accuracy, and empathy 
            ...
            {architectureLayers.map((layer, index) => (
              ...
              >
                <div className="glass-card p-6 rounded-xl h-full text-center group hover:border-mait-cosmic/50 transition-colors">
                  {/* Layer Number */}
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-6 h-6 rounded-full bg-mait-space border border-white/20 flex items-center justify-center">
          ...
          >
            <div className="flex flex-col lg:flex-row items-center justify-between gap-4 text-sm">
              ...
              <div className="hidden lg:block flex-1 h-px bg-gradient-to-r from-green-500/50 via-mait-cyan/50 to-mait-cosmic/50" />
              ...
              <div className="hidden lg:block flex-1 h-px bg-gradient-to-r from-mait-cosmic/50 to-green-500/50" />
              <div className="flex items-center gap-3">

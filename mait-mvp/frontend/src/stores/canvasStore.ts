...
\\vspace{1em}`,
    ...
    },
    {
      ...
      kind: 'question',
      sortKey: 'a2_b_001',
      contentLatex: `\\item % AI generation failed or is unavailable. Edit this placeholder or use the Insert menu to add questions.\n% Topic: ${safeTopic}\n\\textit{[Question placeholder — click Generate or use Insert Menu to add content.]} \\unskip\\hfill\\mbox{\\textbf{[? Marks]}}\n\n\\vspace{3cm}`,

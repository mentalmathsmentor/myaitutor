...
export default function ProblemSection() {
  ...
  const problems = [
    ...
    },
    {
      ...
      stat: '78%',
      statLabel: 'students report fatigue',
      ...
      <div ref={ref} className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
            Schools Face a{' '}
            <span className="text-red-400">Three-Front Crisis</span>
          </h2>
          
          <p className="text-lg text-white/60 max-w-2xl mx-auto">
            In the age of generative AI, NSW schools are struggling with data risks, 
            teacher burnout, and student digital fatigue.
          </p>
        </motion.div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8">
            <div className="lg:w-1/2">
              ...
              <p className="text-white/60 mb-6 leading-relaxed">
                While generic AI tools promise efficiency, they create new problems: 
                inconsistent curriculum alignment, privacy vulnerabilities, and a 
                one-size-fits-all approach that fails diverse learners.
              </p>
              ...
              <div className="relative">
                ...
                <div className="glass-card p-6 rounded-xl space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-white/60">Teacher Workload</span>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-white/60">Student Engagement</span>
                    <span className="text-yellow-400 font-mono">DECLINING</span>
                  </div>
                  <div className="h-3 bg-white/10 rounded-full overflow-hidden">
                    <motion.div
                      initial={{ width: 0 }}
